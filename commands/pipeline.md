...
argument-hint: <task> [--from N] [--to N]
---
...
1. If `--from` or `--to` appear in the arguments above, run the range check and
...
2. If the preflight has not already run in this session, run it once:
